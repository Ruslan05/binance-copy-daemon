...
class MainTrader:
    ...
    def sync_main_account_trades(self):
        self._sync_active_spot_trades()
        self._sync_market_spot_trades()
        self._sync_closed_spot_trades()

    def _sync_active_spot_trades(self):
    ...
    def _sync_market_spot_trades(self):
        for allowed_symbol in config.ALLOWED_SYMBOLS:
            print(allowed_symbol)
    ...
    def _sync_closed_spot_trades(self):
